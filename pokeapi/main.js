...
async function onTdClick(event) {
    ...
    if (response.ok) {
        ...
        table.appendChild(sprite);
        sprite.src = character.sprites.front_default;
        ...
        addRow(tableBody, "Type", character.types[0].type.name);
        
        addRow(tableBody, "Height", character.height);
        addRow(tableBody, "Weight", character.weight);
